 ...
 */
@Repository
public class ProxyServiceImpl implements IProxyService, Serializable{
     ...
     */
    private IProxyHelper proxyHelper;
    
	/**
	 * Constructor with helper
	 */
    @Autowired
	public ProxyServiceImpl(IProxyHelper proxyHelper) {
		super();
	 ...
	 */
	public Object getProxyProperty(String key){
		return proxyHelper.getProxyProperty(key);
	}
